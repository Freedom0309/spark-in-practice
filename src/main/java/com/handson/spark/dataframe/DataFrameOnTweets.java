...
public class DataFrameOnTweets {
  ...
  public Dataset loadData() {
    ...
    // TODO write code here
    Dataset<Row> json = sqlContext.read().json("F:\\IdeaProjects\\spark-in-practice-master\\data\\reduced-tweets.json");
   ...
   *  Find people who are located in Paris
   */
  public Dataset filterByLocation() {
    Dataset dataFrame = loadData();
